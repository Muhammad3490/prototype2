...
submit1.addEventListener("click", (event) => {
  ...
  infoCont.classList.add("info-container", "p-xl", "yellow-gradient");
...
submit2.addEventListener("click", (event) => {
  ...
  bodyInfo.classList.add("info-container", "p-xl", "purple-gradient");
  ...
  suggestionContainer.classList.add("info-container", "p-xl", "red-gradient");
